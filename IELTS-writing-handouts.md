...
---
## 议论文的题型分类
### Discuss both views and give your opinion 讨论双方观点，并且给你的个人观点
> #### 两种个人观点:
> ##### 1) 一方弱一方强
...
**report题请从第一个词看到最后一个词**
### report类型的核心段（原因+解决方案版本）
- 1.直接改写原题，不需要背景引出（考察改写能力）+承上启下（提前总结原因/~~空话过渡~~  推荐不用）
- 2.第一个原因分析（idea--support）
